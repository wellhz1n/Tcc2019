    ...
    <table class="table col-12 w-100 text-center table-active table-bordered table-hover ">
        <thead class="thead-dark">
          ...
          <tr class="text-center">
            ...
            <td class="mt-3"><?php echo  $pesq["nome"]  ?></td>
            <td><?php echo  $pesq["descricao"]  ?></td>
            <td><h5 class="text-danger">R$:<?php echo  $pesq["valor"] ?></h5></td>

            
            
            <td scope="col "><button type="submit"  formaction="pages/forms/adm_form_contato_edit.php" class="btn btn-info"><i class="fa fa-edit"></i>Editar</button> 
